...
#
# Optional arguments:
#  -d <admin account>   : Email of admin account to be added/deleted/matched. Required for commands add, delete and find
...
def printhelp():
    ...
    printusertext(' -d <admin account>   : Email of admin account to be added/deleted/matched. Required for add, delete and find')
