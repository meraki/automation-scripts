...
def main():
    ...
    field_names = ['name', 'serial', 'network', 'networkId', 'lastReportedAt',
                   'wan1_status', 'wan1_ip', 'wan1_gateway', 'wan1_publicIp', 'wan1_primaryDns', 'wan1_secondaryDns', 'wan1_ipAssignedBy', 
                   'wan2_status', 'wan2_ip', 'wan2_gateway', 'wan2_publicIp', 'wan2_primaryDns', 'wan2_secondaryDns', 'wan2_ipAssignedBy',
                   'cellular_status', 'cellular_ip', 'cellular_provider', 'cellular_publicIp', 'cellular_model', 'cellular_signalStat', 'cellular_connectionType', 'cellular_apn']
